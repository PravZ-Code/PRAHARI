      ...
      builder: (context, child) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            color: isCritical
                ? const Color(0xFF450A0A).withValues(alpha: 0.9)
                : const Color(0xFF431407).withValues(alpha: 0.9),
            ...
            boxShadow: [
              BoxShadow(
                color: alertColor.withValues(alpha: 0.25 * _pulseController.value),
                blurRadius: 14,
                spreadRadius: 2,
              ),
            ],
                  ...
                  Expanded(
                    child: OutlinedButton.icon(
                      ...
                      style: OutlinedButton.styleFrom(
                        foregroundColor: Colors.white,
                        side: BorderSide(color: alertColor.withValues(alpha: 0.8)),
                        padding: const EdgeInsets.symmetric(vertical: 10),
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(10),
                        ),
