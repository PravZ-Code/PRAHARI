...
class RiskPrediction(Base):
    ...
    trajectory = Column(String(30), nullable=True, default="STABLE")
    prob_7d = Column(Numeric(5, 4), nullable=True)
    prob_14d = Column(Numeric(5, 4), nullable=True)
    prob_30d = Column(Numeric(5, 4), nullable=True)
    abstention_flag = Column(Integer, nullable=True, default=0)
